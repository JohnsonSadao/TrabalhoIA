...
namespace TelaDeBusca
{
    public partial class Form1 : Form
    {
        ...
        #region
        public static List<Vertice> cidadesOrigem;
        public static List<Vertice> cidadesDestino;
        #endregion
        ...
        public Form1()
        {
            ...
            #endregion
            cidadesOrigem = new List<Vertice> {
               Albania,
               Alemanha,
               Andorra,
               Austria,
            ...
            cidadesDestino = new List<Vertice> {
               Albania,
               Alemanha,
               Andorra,
               Austria,
        ...
        {
            comboBoxCidadeOrigem.DataSource = cidadesOrigem;
        }

        private void PopularListaDestino()
        {
            comboBoxCidadeDestino.DataSource = cidadesDestino;
        }

        public List<Vertice> PegarVizinhos(string nome)
        {
            switch (nome)
            {
                case "Albania":
        ...
        public bool BPLRecursivo(Node no, Vertice cidadeDestino, int limite)
        {
            ...
            foreach (Vertice vertice in PegarVizinhos(no.Vertice.Nome))
            {
                nosExpandidos += 1;
        ...
        {
            listBox1.DataSource = BuscaProfundidadeLimitada((Vertice)comboBoxCidadeOrigem.SelectedItem, (Vertice)comboBoxCidadeDestino.SelectedItem);
            lblNosExpandidos.Text = nosExpandidos.ToString();
            lblNosGerados.Text = nosGerados.ToString();
            lblPassosDados.Text = caminho.Count().ToString();
            lblTempoExecucao.Text = sw.ElapsedMilliseconds.ToString();
        }
